                ...
                <ul id="main-menu" class="">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="skin-black.html">
                                    <span>Informacion de Materias y Alumnos  </span>
                                </a>

                            </li>
                            <li>
                                <a href="skin-black.html">
                                    <span>Informacion de Profesores </span>
                                </a>

                            </li>
                            <li>
                                <a href="skin-black.html">
                                    <span>Calificaciones de estancias y estadia </span>
                                </a>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li class="active">
                                        <a href="index.html">
                                            <span>Reporte de estatus de los alumnos</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="dashboard-2.html">
                                            <span>Reporte de motivos de baja</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="dashboard-2.html">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li class="active">
                                        <a href="index.html">
                                            <span>Generacion y envio de constancias</span>
                                        </a>
                                    </li>
                    ...
                    <li>
                        <a href="index.html" target="_blank">
                            ...
                            <span>Secretaria Academica</span>
                        </a>
                        <ul>
                            <li>
                                <a href="layout-api.html">
                            ...
                            <li>
                                <a href="skin-black.html">
                                    <span>Historial de actividades del sistema </span>
                                </a>
                        ...
                        <ul class="user-info pull-left pull-none-xsm">
                            ...
                            <li class="profile-info dropdown"><!-- add class "pull-right" if you want to place this from right -->
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo Doo::conf()->APP_URL; ?>global/images/avatar/<?php // echo $administrativo->foto;  ?>" alt="" class="img-circle" width="120" />
                                    <?php // echo $administrativo->nombre;  ?>
                                </a>
