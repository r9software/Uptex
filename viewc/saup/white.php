...
<head>
	...
	<link rel="stylesheet" href="<?php echo Doo::conf()->APP_URL; ?>global/css/skins/white.css">
...
<body class="page-body boxed-layout skin-white" data-url="http://neon.dev">
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->	
	...
	<div class="sidebar-menu">
		...
		<header class="logo-env">
			...
			<div class="logo">
				<a href="index.html">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/logo-light@2x.png" width="120" alt="" />
				</a>
			</div>
			...
			<div class="sui-normal">
				<a href="#" class="user-link">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/thumb-1.png" alt="" class="img-circle" />
...
<li class="external">
	...
	<ul class="dropdown-menu-list scroller">
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/thumb-3.png" alt="" class="img-circle" />
				</span>
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/thumb-4.png" alt="" class="img-circle" />
				</span>
		...
		<ul class="list-inline links-list pull-right">
			...
			<!-- Language Selector -->			<li class="dropdown language-selector">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/flag-uk.png" />
				</a>
				
				<ul class="dropdown-menu pull-right">
					<li>
						<a href="#">
							<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/flag-de.png" />
							<span>Deutsch</span>
						</a>
					</li>
					<li class="active">
					...
					<li>
						<a href="#">
							<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/flag-fr.png" />
							<span>François</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/flag-al.png" />
							<span>Shqip</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/flag-es.png" />
							<span>Español</span>
						</a>
					</li>
				</ul>
	...
	<div class="col-sm-9">
		...
		<div class="tile-group">
			...
			<div class="tile-left">
				...
				<div class="tile-entry">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/sample-al.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/sample-it.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="<?php echo Doo::conf()->APP_URL; ?>global/images/sample-au.png" alt="" class="pull-right op" />
